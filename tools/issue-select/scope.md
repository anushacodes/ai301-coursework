...
My focus is AI engineering and full-stack development, with more interest
in backend work. I like working with Python and TypeScript. I would
prefer a backend issue connected to AI tooling, such as handling model
output, retrieval, or an agent tool, where I can make a focused change
and check it with tests. I can spend about 4–6 hours on this first
contribution, including setup and testing.
